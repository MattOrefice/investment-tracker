...
prose migrations via `python tools/sync_personal_prose.py`, which sequences all
four in order and documents why they are manual, not auto-discovered on bootstrap.
"""
import sqlite3
